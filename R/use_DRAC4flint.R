...
use_DRAC4flint <- function (
  ...
  if(is.null(De) || length(De) == 0 || De == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$De$De' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(De.err) || length(De.err) == 0 || De.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$De$De.err' have to be of type 'numeric' and finite.")
  }
  ## ------------------------------------------------------------------------------------------
  ...
  if(is.null(int.U) || length(int.U) == 0 || int.U == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$U' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.U.err) || length(int.U.err) == 0 || int.U.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$U.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.Th) || length(int.Th) == 0 || int.Th == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$Th' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.Th.err) || length(int.Th.err) == 0 || int.Th.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$Th.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.K) || length(int.K) == 0 || int.K == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$K' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.K.err) || length(int.K.err) == 0 || int.K.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$K.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.Rb) || length(int.Rb) == 0 || int.Rb == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$Rb' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.K2Rb) || length(int.K2Rb) == 0){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$K2Rb' have to be 'Y' or 'N'.")
  }
  ...
  if(is.null(int.alpha) || length(int.alpha) == 0 || int.alpha == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$alpha' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.alpha.err) || length(int.alpha.err) == 0 || int.alpha.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$alpha.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.beta) || length(int.beta) == 0 || int.beta == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$beta' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.beta.err) || length(int.beta.err) == 0 || int.beta.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$beta.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.gamma) || length(int.gamma) == 0 || int.gamma == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$gamma' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.gamma.err) || length(int.gamma.err) == 0 || int.gamma.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$Dr$gamma.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.U) || length(env.U) == 0 || env.U == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$U' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.U.err) || length(env.U.err) == 0 || env.U.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$U.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.Th) || length(env.Th) == 0 || env.Th == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$Th' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.Th.err) || length(env.Th.err) == 0 || env.Th.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$Th.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.K) || length(env.K) == 0 || env.K == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$K' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.K.err) || length(env.K.err) == 0 || env.K.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$K.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.Rb) || length(env.Rb) == 0 || env.Rb == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$Rb' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.K2Rb) || length(env.K2Rb) == 0){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$K2Rb' have to be 'Y' or 'N'.")
  }
  ...
  if(is.null(env.alpha) || length(env.alpha) == 0 || env.alpha == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$alpha' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.alpha.err) || length(env.alpha.err) == 0 || env.alpha.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$alpha.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.beta) || length(env.beta) == 0 || env.beta == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$beta' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.beta.err) || length(env.beta.err) == 0 || env.beta.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$beta.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.gamma) || length(env.gamma) == 0 || env.gamma == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$gamma' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.gamma.err) || length(env.gamma.err) == 0 || env.gamma.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$gamma.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.size.min) || length(int.size.min) == 0 || int.size.min == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$grain.size.min' have to be of type 'numeric' and finite.")
  }
  if(int.size.min < 1){
    int.size.min <- 1
  }
  ...
  if(is.null(int.size.max) || length(int.size.max) == 0 || int.size.max == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$grain.size.max' have to be of type 'numeric' and finite.")
  }
  if(int.size.max > 1000){
    int.size.max <- 1000
  }
  if(int.size.min > int.size.max){
    stop("[use_DRAC4flint] Error: 'data$flint$info$size.min' > 'data$flint$info$int.size.max'")
  }
  ...
  if(is.null(int.etch.min) || length(int.etch.min) == 0 || int.etch.min == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$grain.etch.min' have to be of type 'numeric' and finite.")
  }
  if(int.size.min < 0){
    int.size.min <- 0
  }
  ...
  if(is.null(int.a.value) || length(int.a.value) == 0 || int.a.value == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$a.value' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(int.a.value.err) || length(int.a.value.err) == 0 || int.a.value.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$a.value.err' have to be of type 'numeric' and finite.")
  }
  ## ------------------------------------------------------------------------------------------
  ...
  if(is.null(ext.water) || length(ext.water) == 0 || ext.water == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$water.content' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(ext.water.err) || length(ext.water.err) == 0 || ext.water.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$water.content.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(ext.density) || length(ext.density) == 0 || ext.density == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$density' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(ext.density.err) || length(ext.density.err) == 0 || ext.density.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$flint$info$density.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.water) || length(env.water) == 0 || env.water == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$info$water.content' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.water.err) || length(env.water.err) == 0 || env.water.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$info$water.content.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.density) || length(env.density) == 0 || env.density == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$info$density' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.density.err) || length(env.density.err) == 0 || env.density.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$info$density.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(env.scale4shallow.depth) || length(env.scale4shallow.depth) == 0){
    ...
    stop("[use_DRAC4flint] Error: 'data$sediment$Dr$scale4shallow.depth' have to be 'Y' or 'N'.")
  }
  ## ------------------------------------------------------------------------------------------
  ...
  if(is.null(depth) || length(depth) == 0 || depth == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$cosmic$depth' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(depth.err) || length(depth.err) == 0 || depth.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$cosmic$depth.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(latitude) || length(latitude) == 0 || latitude == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$cosmic$latitude' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(longitude) || length(longitude) == 0 || longitude == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$cosmic$longitude' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(altitude) || length(altitude) == 0 || altitude == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$cosmic$altitude' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(cosmic) || length(cosmic) == 0 || cosmic == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$cosmic$Dr' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(cosmic.err) || length(cosmic.err) == 0 || cosmic.err == "X"){
    ...
    stop("[use_DRAC4flint] Error: 'data$cosmic$Dr.err' have to be of type 'numeric' and finite.")
  }
  ...
  if(is.null(corr.fieldChanges) || length(corr.fieldChanges) == 0){
    ...
    stop("[use_DRAC4flint] Error: 'data$cosmic$corr.fieldChanges' have to be 'Y' or 'N'.")
  }
  ...
  #####
  env.input$`User cosmicdoserate (Gy.ka-1)` <- cosmic
  env.input$`errUser cosmicdoserate (Gy.ka-1)` <- cosmic.err
  #####
  ...
  # DRAC.int.Dr <- sum(temp.int.alpha,temp.int.beta,na.rm = TRUE)
  # DRAC.int.Dr.err <- sqrt(sum(temp.int.alpha.err^2, temp.int.beta.err^2,na.rm = TRUE))

  DRAC.ext.Dr <- sum(temp.ext.alpha,temp.ext.beta,na.rm = TRUE)
  DRAC.ext.Dr.err <- sqrt(sum(temp.ext.alpha.err^2, temp.ext.beta.err^2,na.rm = TRUE))

  DRAC.env.Dr <- sum(temp.env.gamma,temp.cosmic,na.rm = TRUE)
  DRAC.env.Dr.err <- sqrt(sum(temp.env.gamma.err^2, temp.cosmic.err^2,na.rm = TRUE))

  DRAC.alpha.Dr <- sum(temp.int.alpha,temp.ext.alpha,na.rm = TRUE)
  DRAC.alpha.Dr.err <- sqrt(sum(temp.int.alpha.err^2, temp.ext.alpha.err^2,na.rm = TRUE))

  DRAC.beta.Dr <- sum(temp.int.beta,temp.ext.beta,na.rm = TRUE)
  DRAC.beta.Dr.err <- sqrt(sum(temp.int.beta.err^2, temp.ext.beta.err^2,na.rm = TRUE))
  ...
  if(!is.finite(age.CE)){
    message.CE <- "The age of the flint is unknown."
  }else if(age.CE > 0){
